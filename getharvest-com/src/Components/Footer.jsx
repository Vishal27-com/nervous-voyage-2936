...
import { community, contact, f_company, harvest } from '../Routes/Home/homeData';
const Footer = () => {
    return (
        <Box bgColor='black' color='white' fontSize='18px' p='40px 20px'>
           <SimpleGrid columns={[1,1,3,4]} >
           
            <Box display={['none','none','none','block']} color='#FFF' >
          <svg width="159" height="32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Box align='left'>
           <Heading size='md' m='15px 0'>Harvest</Heading>
           
           {
            ...
            <Box align='left'>
           <Heading size='md' m='15px 0'>Community</Heading>
           {
            community.map(el=>
            <Text 
            key={el}
            ...
            <Box align='left'>
           <Heading size='md' m='15px 0'>Company</Heading>
           {
            f_company.map(el=>
            <Text 
            key={el}
        ...
        <Box mt='30px'>
            <Flex gap='20px' justify='center'>
                {contact.map(el=>  
            <Box key={el} _hover={{color:'orange',"cursor":'pointer'}} >
            <Flex  h='50px' align='center'>
            <Box w='40px' borderRadius='100%'  bgColor='Grey' border='3px solid black'><Img  src={el.icon} /></Box>
            <Text align='left'>{el.title}</Text>
            </Flex>
            </Box>
        )}
            </Flex>
            <Box color='grey'>© 2006-2022 Harvest</Box>
        </Box>
        </Box>
    );
};
