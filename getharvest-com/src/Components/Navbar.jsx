...
const Navbar = () => {
    return (
        <Box h='80px' boxShadow={['base']} position='sticky' top='0px' bgColor={['#FBF6EF']}>
                <Flex align='center' justify='space-between' h='80px'>
            <Box ml='80px'>
            <HStack spacing='25px'>
         <Link to='/'>
         <Box color='#FA5D00' borderRight='1px solid lightgrey' pr='10px'>
          ...
          <Box>
            <HStack spacing='15px'>
               <Link to='/why-harvest'><Text fontSize='18px'>Why Harvest?</Text></Link>
                <Link to='/features'><Text fontSize='18px'>Features</Text></Link>
                <Link to='/customers'><Text fontSize='18px'>Customers</Text></Link>
                <Link to='/integrations'><Text fontSize='18px'>Integration</Text></Link>
                <Link to='/pricing'><Text fontSize='18px'>Pricing</Text></Link>
            </HStack>
          </Box>
            </HStack>
                </Box>        
