...
const Signin = () => {
    ...
    <Box>
        ...
        <Text fontSize='30px'>Sign in to Harvest</Text>
        <Box bg='#FBF6EF' w='35%' m='20px auto' border='1px solid orange' p='20px'>
            <Input bg='white' fontSize='20px' p='10px' m='5px' borderRadius='10px' type='email' placeholder='Work email' />
            <Input bg='white' type='password' placeholder='Password' fontSize='20px' p='10px' m='5px' borderRadius='10px' />
            <Button
            bg='green'
            color='white'
            width='100%'
        ...
        <Box w='28%' m='auto'>
            <Flex gap='15px'>
            <Text color='grey' _hover={{textDecoration:'underline'}}>Forgot Password</Text>
            <Text color='grey' _hover={{textDecoration:'underline'}}>Term of Service</Text>
            <Text color='grey' _hover={{textDecoration:'underline'}}>Privacy Policy</Text>
            </Flex>
        </Box>
    </Box>
    );
