...
const Capacity = () => {
    return (
        <Box pl='400px' pt='20px' bg='#FBF6EF' h='98vh'>
            <Box mb='50px' >
            ...
            <Text m='10px 0' fontSize='30px' align='left'>What do you want to accomplish with Harvest?</Text>
            <Text m='10px 0' fontSize='18px' color='grey' align='left'>Please select all that apply.</Text>
        <Box align='left'  w='50%'>
            <Checkbox colorScheme='red'>I want to track billable time to properly bill my clients</Checkbox>
            <Checkbox colorScheme='red'>I want to make sure my business is on track</Checkbox>
            <Checkbox colorScheme='red'>I want to better estimate future projects</Checkbox>
            <Checkbox colorScheme='red'>I want to provide evidence of what my team did</Checkbox>
                <Button
                bg='green'
                color='white'
                width='100%'
