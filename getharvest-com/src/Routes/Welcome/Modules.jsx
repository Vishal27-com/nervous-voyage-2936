...
const Modules = () => {
    return (
        ...
        <Box align='left'  w='50%'>
            <Checkbox colorScheme='red'>Expense tracking</Checkbox>
            <Checkbox colorScheme='red'>Approving my team's time and expenses</Checkbox>
            <Checkbox colorScheme='red'>Invoicing my clients</Checkbox>
            <Checkbox colorScheme='red'>Sending project estimates to my clients</Checkbox>
                <Button
                bg='green'
                color='white'
                width='100%'
