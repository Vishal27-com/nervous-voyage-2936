...
const Welcome = () => {
    return (
        <Box pl='400px' pt='20px' bg='#FBF6EF' h='98vh'>
            ...
            <Text m='10px 0' fontSize='30px' align='left'>Welcome to Harvest</Text>
            <Text m='10px 0' fontSize='18px' color='grey' align='left'>We just have a few quick questions to setup your account...</Text>
        <Box align='left'  w='50%'>
            <Text m='10px 0'>First, about how many people will be using Harvest?</Text>
            <Select m='10px 0' bg='white' fontSize='18px'>
