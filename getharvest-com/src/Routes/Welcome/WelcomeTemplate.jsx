...
const WelcomeTemplate = ({head1,head2,body,but_name,link,submitHandler}) => {
    return (
    <Box pl='400px' pt='20px' bg='#FBF6EF' h='98vh'>
        ...
        <Text m='10px 0' fontSize='30px' w='50%' align='left'>{head1}</Text>
        <Text m='10px 0' fontSize='18px' w='50%' color='grey' align='left'>{head2}</Text>
        <Box align='left'  w='50%'>
            {body}
            <Link to={link}> <Button
            mt='20px'
